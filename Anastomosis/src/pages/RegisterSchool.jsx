    ...
    try {
      ...
      if (!user) {
        try {
          ...
          setError(
            "Google sign-in failed. Please allow the popup and try again."
          );
          setLoading(false);
          return;
        }
        ...
        {isRegistered ? (
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-green-50 border-2 border-green-200 rounded-2xl p-8 text-center">
              ...
              {registrationData && (
                <div className="bg-white rounded-lg p-6 text-left mt-4">
                  ...
                  <div className="space-y-2 text-gray-700">
                    ...
                    {registrationData.teacherName && (
                      <p>
                        <span className="font-medium">Teacher POC:</span>{" "}
                        {registrationData.teacherName}
                      </p>
                    )}
                    {registrationData.teacherPhone && (
                      <p>
              ...
              <p className="text-gray-600 mt-6 text-sm">
                ...
                <a
                  href="mailto:anastomosis@edciitd.com"
                  className="text-blue-600 underline"
                >
                  anastomosis@edciitd.com
                </a>
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <section
              ...
              className="lg:col-span-2 bg-white rounded-2xl shadow-md border border-gray-200 p-8"
            >
              {error && (
              ...
              {success && (
                <div className="bg-green-50 border border-green-100 text-green-700 p-3 rounded mb-4">
                  {success}
                </div>
              )}
                ...
                <div className="mb-4 flex items-center justify-center">
                  ...
                  >
                    ...
                    >
                      <path
                        fill="#EA4335"
                        d="M24 9.5c3.9 0 6.7 1.7 8.3 3l6-6C35.9 2.9 30.4 0 24 0 14.1 0 5.9 4.9 1.9 12.2l7.2 5.6C11.6 12 17 9.5 24 9.5z"
                      />
                      <path
                        fill="#34A853"
                        d="M46.5 24.3c0-1.6-.1-2.6-.4-3.7H24v7h12.9c-.6 3.2-2.9 7.5-8.2 10.2l7.2 5.6C43.7 40.6 46.5 33.6 46.5 24.3z"
                      />
                      <path
                        fill="#4A90E2"
                        d="M10.3 31.4c-.8-2.4-1.3-4.9-1.3-7.4 0-2.5.5-4.9 1.3-7.3L4.4 11C.8 15.6 0 19.8 0 25s.8 9.4 4.4 12.9l6-6z"
                      />
                      <path
                        fill="#FBBC05"
                        d="M24 48c6.5 0 12-2.1 16-5.7l-7.2-5.6C29.6 37.5 27 38.5 24 38.5c-7 0-12.4-2.5-15.9-6.1l-6 6C5.9 43.1 14.1 48 24 48z"
                      />
                    </svg>
              ...
              >
                ...
                <div className="sm:col-span-2 flex items-center gap-3 justify-end">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-3 rounded-md font-semibold shadow"
                  >
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-4 shadow-sm lg:sticky lg:top-28 lg:max-w-[320px] lg:self-start">
                ...
                <ul className="space-y-3 text-gray-600 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      We save your submission and notify our coordination team.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg
                      ...
                      viewBox="0 0 20 20"
                    >
                      <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016.832 4H3.168a2 2 0 00-1.165.884z" />
                      <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                    </svg>
                    <div>
                      We'll contact the teacher POC for confirmation and
                      logistics.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                ...
                <div className="border-t border-gray-100 mt-5 pt-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Email us at{" "}
                    <a
                      href="mailto:anastomsis@edciitd.com"
                      className="text-blue-600"
                    >
                      anastomsis@edciitd.com
                    </a>
                  </p>
                </div>
              </div>
